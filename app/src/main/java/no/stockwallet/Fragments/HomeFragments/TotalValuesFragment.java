 ...
 * Use the {@link TotalValuesFragment#newInstance} factory method to
...
public class TotalValuesFragment extends Fragment {
     ...
     * @return A new instance of fragment TotalValuesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TotalValuesFragment newInstance(String param1, String param2) {
        TotalValuesFragment fragment = new TotalValuesFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("ViewModel", "CREATING TOTALVALUESFRAGMENT");
